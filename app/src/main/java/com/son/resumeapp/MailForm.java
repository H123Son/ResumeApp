 ...
 * {@link OnMailFormFragmentInteractionListener} interface
...
public class MailForm extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getResources().getString(R.string.mailFormLabel));
         ...
         EditText subjectField = getView().findViewById(R.id.subjectText);
        final EditText bodyField = getView().findViewById(R.id.bodyText);
        Button sendMailButton = getView().findViewById(R.id.sendMailButton);
